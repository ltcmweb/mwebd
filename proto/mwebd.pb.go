...
type LedgerKeysRequest struct {
	state         protoimpl.MessageState
	sizeCache     protoimpl.SizeCache
	unknownFields protoimpl.UnknownFields

	HdPath         []uint32 `protobuf:"varint,1,rep,packed,name=hd_path,json=hdPath,proto3" json:"hd_path,omitempty"`
	ConfirmAddress bool     `protobuf:"varint,2,opt,name=confirm_address,json=confirmAddress,proto3" json:"confirm_address,omitempty"`
}

func (x *LedgerKeysRequest) Reset() {
	*x = LedgerKeysRequest{}
	if protoimpl.UnsafeEnabled {
...
func (x *LedgerKeysRequest) String() string {
	return protoimpl.X.MessageStringOf(x)
}

func (*LedgerKeysRequest) ProtoMessage() {}

func (x *LedgerKeysRequest) ProtoReflect() protoreflect.Message {
	mi := &file_mwebd_proto_msgTypes[6]
	if protoimpl.UnsafeEnabled && x != nil {
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		if ms.LoadMessageInfo() == nil {
...
// Deprecated: Use LedgerKeysRequest.ProtoReflect.Descriptor instead.
func (*LedgerKeysRequest) Descriptor() ([]byte, []int) {
	return file_mwebd_proto_rawDescGZIP(), []int{6}
}

func (x *LedgerKeysRequest) GetHdPath() []uint32 {
	if x != nil {
		return x.HdPath
	}
	return nil
...
func (x *LedgerKeysRequest) GetConfirmAddress() bool {
	if x != nil {
...
type LedgerKeysResponse struct {
	state         protoimpl.MessageState
	sizeCache     protoimpl.SizeCache
	unknownFields protoimpl.UnknownFields

	ScanSecret  []byte `protobuf:"bytes,1,opt,name=scan_secret,json=scanSecret,proto3" json:"scan_secret,omitempty"`
	SpendPubkey []byte `protobuf:"bytes,2,opt,name=spend_pubkey,json=spendPubkey,proto3" json:"spend_pubkey,omitempty"`
}

func (x *LedgerKeysResponse) Reset() {
	*x = LedgerKeysResponse{}
	if protoimpl.UnsafeEnabled {
...
func (x *LedgerKeysResponse) String() string {
	return protoimpl.X.MessageStringOf(x)
}

func (*LedgerKeysResponse) ProtoMessage() {}

func (x *LedgerKeysResponse) ProtoReflect() protoreflect.Message {
	mi := &file_mwebd_proto_msgTypes[7]
	if protoimpl.UnsafeEnabled && x != nil {
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		if ms.LoadMessageInfo() == nil {
...
// Deprecated: Use LedgerKeysResponse.ProtoReflect.Descriptor instead.
func (*LedgerKeysResponse) Descriptor() ([]byte, []int) {
	return file_mwebd_proto_rawDescGZIP(), []int{7}
}

func (x *LedgerKeysResponse) GetScanSecret() []byte {
	if x != nil {
		return x.ScanSecret
	}
	return nil
...
func (x *LedgerKeysResponse) GetSpendPubkey() []byte {
	if x != nil {
		return x.SpendPubkey
	}
	return nil
...
type CreateRequest struct {
	...
	// If spend secret is zero, this is the HD path to use with
	// the Ledger.
	HdPath []uint32 `protobuf:"varint,6,rep,packed,name=hd_path,json=hdPath,proto3" json:"hd_path,omitempty"`
}
...
func (x *CreateRequest) GetHdPath() []uint32 {
	if x != nil {
		return x.HdPath
	}
	return nil
...
var file_mwebd_proto_rawDesc = []byte{
	...
	,
	...
	,
	...
	,
	...
	,
...
var file_mwebd_proto_msgTypes = make([]protoimpl.MessageInfo, 15)
var file_mwebd_proto_goTypes = []any{
	...
	(*LedgerKeysRequest)(nil),  // 6: LedgerKeysRequest
	(*LedgerKeysResponse)(nil), // 7: LedgerKeysResponse
	(*LedgerApdu)(nil),         // 8: LedgerApdu
	(*SpentRequest)(nil),       // 9: SpentRequest
	(*SpentResponse)(nil),      // 10: SpentResponse
	(*CreateRequest)(nil),      // 11: CreateRequest
	(*CreateResponse)(nil),     // 12: CreateResponse
	(*BroadcastRequest)(nil),   // 13: BroadcastRequest
	(*BroadcastResponse)(nil),  // 14: BroadcastResponse
}
var file_mwebd_proto_depIdxs = []int32{
	...
	6,  // 3: Rpc.LedgerKeys:input_type -> LedgerKeysRequest
	9,  // 4: Rpc.Spent:input_type -> SpentRequest
	11, // 5: Rpc.Create:input_type -> CreateRequest
	8,  // 6: Rpc.LedgerExchange:input_type -> LedgerApdu
	13, // 7: Rpc.Broadcast:input_type -> BroadcastRequest
	1,  // 8: Rpc.Status:output_type -> StatusResponse
	3,  // 9: Rpc.Utxos:output_type -> Utxo
	5,  // 10: Rpc.Addresses:output_type -> AddressResponse
	7,  // 11: Rpc.LedgerKeys:output_type -> LedgerKeysResponse
	10, // 12: Rpc.Spent:output_type -> SpentResponse
	12, // 13: Rpc.Create:output_type -> CreateResponse
	8,  // 14: Rpc.LedgerExchange:output_type -> LedgerApdu
	14, // 15: Rpc.Broadcast:output_type -> BroadcastResponse
...
func file_mwebd_proto_init() {
	...
	if !protoimpl.UnsafeEnabled {
		...
		file_mwebd_proto_msgTypes[6].Exporter = func(v any, i int) any {
			switch v := v.(*LedgerKeysRequest); i {
			case 0:
				return &v.state
			case 1:
				return &v.sizeCache
		...
		file_mwebd_proto_msgTypes[7].Exporter = func(v any, i int) any {
			switch v := v.(*LedgerKeysResponse); i {
			case 0:
				return &v.state
			case 1:
				return &v.sizeCache
		...
		file_mwebd_proto_msgTypes[13].Exporter = func(v any, i int) any {
		...
		file_mwebd_proto_msgTypes[14].Exporter = func(v any, i int) any {
